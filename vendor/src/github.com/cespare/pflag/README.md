This fork (cespare's) of pflag only exists to serve as a stable library for my (cespare's) tools, due to the
lack of library versioning functionality in the `go` tool at this time.
